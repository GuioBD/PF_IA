...
public class MainActivity extends AppCompatActivity {
    ...
    public String obtenerColorPixelHTML() {
        ...
        // Convierte los componentes RGB a formato HTML
        String htmlColor = "HTML: " + String.format("#%02X%02X%02X", blue, green, red);
        return htmlColor;
    }
    public void obtenerColorRGB(View view) {
        if (bitmap != null) {
            ...
            Toast.makeText(this, colorRGB + "  " + obtenerColorPixelHTML(), Toast.LENGTH_SHORT).show();
        }
    }
